...
from datasets.models import Dataset, Feature, Attribute, AttributeValue
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        dir_name = '/home/saroj/work/naxa/geoportal/final_data/'
        shapefile_name = 'District.shp'
        ...
        for i in range(layer.GetFeatureCount()):
            ...
            for attr in attributes:
                ...
                attr_value = AttributeValue(feature=feature,
                                            attribute=attr,
                                            value=result)
                attr_val_objs.append(attr_value)

            AttributeValue.objects.bulk_create(attr_val_objs)
